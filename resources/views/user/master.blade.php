...
<html lang="en">
  <head>
    ...
    <link href="{{asset('judge-master')}}/https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800,900" rel="stylesheet">
    <link href="{{asset('judge-master')}}/https://fonts.googleapis.com/css?family=Playfair+Display:400,400i,700,700i,900,900i&display=swap" rel="stylesheet">

    <link rel="stylesheet" href="{{asset('judge-master')}}/css/open-iconic-bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('judge-master')}}/css/animate.css">
    
    <link rel="stylesheet" href="{{asset('judge-master')}}/css/owl.carousel.min.css">
    <link rel="stylesheet" href="{{asset('judge-master')}}/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="{{asset('judge-master')}}/css/magnific-popup.css">

    <link rel="stylesheet" href="{{asset('judge-master')}}/css/aos.css">

    <link rel="stylesheet" href="{{asset('judge-master')}}/css/ionicons.min.css">
    
    <link rel="stylesheet" href="{{asset('judge-master')}}/css/flaticon.css">
    <link rel="stylesheet" href="{{asset('judge-master')}}/css/icomoon.css">
    <link rel="stylesheet" href="{{asset('judge-master')}}/css/style.css">
  </head>
  <body>
	    ...
	    <div class="container-fluid px-md-5">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="{{url('user')}}" class="nav-link">Home</a></li>
	          <li class="nav-item"><a href="{{url('user/about')}}" class="nav-link">About Us</a></li>
  ...
  <script src="{{asset('judge-master')}}/js/jquery.min.js"></script>
  <script src="{{asset('judge-master')}}/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="{{asset('judge-master')}}/js/popper.min.js"></script>
  <script src="{{asset('judge-master')}}/js/bootstrap.min.js"></script>
  <script src="{{asset('judge-master')}}/js/jquery.easing.1.3.js"></script>
  <script src="{{asset('judge-master')}}/js/jquery.waypoints.min.js"></script>
  <script src="{{asset('judge-master')}}/js/jquery.stellar.min.js"></script>
  <script src="{{asset('judge-master')}}/js/owl.carousel.min.js"></script>
  <script src="{{asset('judge-master')}}/js/jquery.magnific-popup.min.js"></script>
  <script src="{{asset('judge-master')}}/js/aos.js"></script>
  <script src="{{asset('judge-master')}}/js/jquery.animateNumber.min.js"></script>
  <script src="{{asset('judge-master')}}/js/scrollax.min.js"></script>
  <script src="{{asset('judge-master')}}/https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="{{asset('judge-master')}}/js/google-map.js"></script>
  <script src="{{asset('judge-master')}}/js/main.js"></script>
